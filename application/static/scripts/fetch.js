import {click_create_questionnaire} from "./click.js";
...
document.addEventListener('DOMContentLoaded', function() {
    var create_quiz = document.getElementById('add_quiz');
    create_quiz.addEventListener('click', function() {
        var name = document.getElementById('quiz_name').value;
        click_create_questionnaire(name).then(r => console.log(r)).catch(e => console.log(e));
    });
});
